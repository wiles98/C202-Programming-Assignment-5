...
public class BinarySearchTree<E extends Comparable<E>> extends AbstractTree<E> {
    ...
    /**
     * Returns true if the element is in the tree, keeps a comparison counter
     */
    ...
    /**
     * Preorder traversal from a subtree, keeps track using an ArrayList
     */
    protected void preorder(TreeNode<E> root, ArrayList<E> list) {
        if (root != null) {
     ...
     * @return - ArrayList of elements on path to the element
     */
     ...
     * @return - integer of the number of leaves for the tree
     */
     ...
     * exists
     * @param e - element whose left subtree is sought
     * @return - ArrayList of the left subtree
     */
     ...
     * exists
     * @param e - element whose right subtree is sought
     * @return - ArrayList of the left subtree
     */
    ...
    /**
     * public method to check if two BST's are equal
    ...
    /**
     * private method to check if two BST's are equal
    ...
    private boolean sameTree(TreeNode<E> root1, TreeNode<E> root2) {
        if (root1 == null && root2 == null)
            ...
            return root1.element.equals(root2.element) && sameTree(root1.left, root2.left)
